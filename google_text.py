...
lab_txt=Label(root,text="Enter Text",font=("Time New Roman",20,"bold"),fg="Black",bg="sky blue")
...
lab_txt=Label(root,text="Translation",font=("Time New Roman",20,"bold"),fg="Black",bg="sky blue")
